    ...
    <form method="POST" action="/admin/companies" style="max-width:40rem;">
        ...
        <x-card class="mb-4">
            <div style="padding:1.25rem;display:flex;flex-direction:column;gap:1rem;">
                <h3 style="font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--surface-500);">Company Details</h3>
                ...
                <hr style="border:none;border-top:1px solid var(--surface-100);margin:.25rem 0;">
                <h3 style="font-size:.75rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--surface-500);">Admin User</h3>
        ...
        <div style="display:flex;gap:.5rem;margin-top:1rem;">
            ...
            <a href="/admin/companies" class="btn btn-ghost" style="border:1px solid var(--surface-200);">Cancel</a>
        </div>
    </form>
</div>
@endsection