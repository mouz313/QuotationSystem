...
<div class="fade-in">
    <x-page-header title="Edit: {{ $label }}" subtitle="Customize the email subject and body for this template" back="/admin/email-templates">
        <x:slot name="actions">
            <div style="display:flex;align-items:center;gap:.5rem;color:var(--gray-400);font-size:.8125rem;">
        ...
        <div style="display:grid;grid-template-columns:2fr 1fr;gap:1.5rem;">
            ...
            <div style="display:flex;flex-direction:column;gap:1.5rem;">
                    ...
                    <div class="d-card-body" style="display:flex;flex-direction:column;gap:1.25rem;">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;padding-bottom:1rem;border-bottom:1px solid var(--gray-100);">
                            <div style="display:flex;align-items:center;gap:.75rem;">
                                <div style="width:2.25rem;height:2.25rem;border-radius:.5rem;background:var(--gray-50);display:flex;align-items:center;justify-content:center;">
                                    <svg style="width:1rem;height:1rem;color:var(--gray-500);" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                </div>
                                <div>
                                    <div style="font-size:.8125rem;font-weight:600;color:var(--gray-700);">Template Visibility</div>
                                    <div style="font-size:.7rem;color:var(--gray-400);">Enable or disable this email template</div>
                                </div>
                            </div>
                            <label style="position:relative;display:inline-flex;align-items:center;cursor:pointer;">
                                ...
                                <div style="width:2.75rem;height:1.5rem;background:var(--gray-200);border-radius:999px;transition:background .2s;" id="toggleBg"></div>
                            </label>
                        </div>
                ...
                <div style="display:flex;align-items:center;gap:.75rem;">
                    ...
                    <a href="/admin/email-templates" class="btn btn-ghost" style="border:1px solid var(--gray-200);">
                        Cancel
                    </a>
                </div>
            </div>
            ...
            <div style="display:flex;flex-direction:column;gap:1.5rem;">
                <div class="d-card">
                    <div class="d-card-body">
                        <h3 style="display:flex;align-items:center;gap:.5rem;font-size:.8125rem;font-weight:700;color:var(--gray-800);margin-bottom:1rem;">
                        ...
                        <p style="font-size:.7rem;color:var(--gray-400);margin-bottom:1rem;">Click to copy. These are replaced with real values when the email is sent.</p>
                        <div style="display:flex;flex-direction:column;gap:.5rem;">
                            <button type="button" onclick="navigator.clipboard.writeText('{{company_name}}')"
                                style="width:100%;display:flex;align-items:center;gap:.75rem;padding:.625rem .75rem;background:var(--gray-50);border-radius:.5rem;text-align:left;transition:background .15s;border:none;cursor:pointer;font-size:.8125rem;"
                                onmouseover="this.style.background='var(--brand-50)'" onmouseout="this.style.background='var(--gray-50)'">
                                <code style="font-size:.75rem;font-family:monospace;font-weight:600;color:var(--brand-600);">{!! '{{company_name}}' !!}</code>
                                <svg style="width:.875rem;height:.875rem;margin-left:auto;color:var(--gray-300);" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                            </button>
                ...
                <div style="background:var(--amber-50);border:1px solid var(--amber-100);border-radius:.75rem;padding:1rem;">
                    <div style="display:flex;align-items:flex-start;gap:.5rem;">
                        <svg style="width:1rem;height:1rem;margin-top:.125rem;flex-shrink:0;color:var(--amber-500);" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>
                        <div style="font-size:.7rem;color:var(--amber-700);">
                            <p style="font-weight:700;margin-bottom:.25rem;">HTML Content</p>
                            <p>You can use full HTML tags like <code style="background:var(--amber-100);padding:0 .25rem;border-radius:.25rem;">&lt;h1&gt;</code>, <code style="background:var(--amber-100);padding:0 .25rem;border-radius:.25rem;">&lt;p&gt;</code>, <code style="background:var(--amber-100);padding:0 .25rem;border-radius:.25rem;">&lt;a&gt;</code> in the body field.</p>
                        </div>
                    </div>
                </div>
            </div>
