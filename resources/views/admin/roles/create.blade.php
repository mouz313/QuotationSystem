    ...
    <form method="POST" action="/admin/roles" style="max-width:42rem;">
        ...
        <x-card>
            <div style="display:flex;flex-direction:column;gap:1.5rem;">
                ...
                <div>
                    <label style="font-size:.8125rem;font-weight:600;color:var(--gray-700);display:block;margin-bottom:.75rem;">Permissions</label>
                    ...
                    @error('permissions')
                        <p style="color:var(--red-600);font-size:.75rem;margin-top:.25rem;">{{ $message }}</p>
                    @enderror
                </div>
            </div>
        </x-card>
        <div style="display:flex;gap:.5rem;margin-top:1rem;">
            ...
            <a href="/admin/roles" class="btn btn-ghost" style="border:1px solid var(--gray-200);">Cancel</a>
        </div>
    </form>
</div>
@endsection
