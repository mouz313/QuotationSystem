...
<body class="min-h-screen flex">
    ...
    <nav class="absolute top-0 left-0 right-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="/register" class="px-4 py-2 text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors">Register</a>
                <a href="/register" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-all hover:shadow-lg">Get Started</a>
            </div>
        </div>
    </nav>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 bg-white">
        <div class="w-full max-w-md" data-animate>
            ...
            @if($errors->any())
                <div class="mb-4 p-3 bg-red-50 border border-red-200 text-red-600 rounded-lg text-sm flex items-start gap-2">
    ...
    <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-600 to-indigo-800 items-center justify-center p-16 relative overflow-hidden">
        ...
        <div class="relative text-center text-white max-w-md" data-animate>
            ...
            <p class="text-indigo-200 text-sm leading-relaxed mb-8">Create, track, and manage professional quotations in minutes. Multi-tenant, multi-currency, built for teams.</p>
            <a href="/register" class="inline-block px-8 py-3 bg-white text-indigo-700 font-semibold rounded-xl hover:bg-indigo-50 transition shadow-lg">
                Create Account
            </a>
        </div>
    </div>
