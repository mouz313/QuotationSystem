<section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 w-80 h-80 bg-purple-100 rounded-full blur-3xl opacity-40 translate-y-1/2 -translate-x-1/3"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            @if(Route::has('register'))
                <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition">
                    Start Free Trial
                </a>
            @endif
            <a href="#features" class="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-gray-700 bg-white rounded-xl border border-gray-200 hover:border-indigo-300 hover:text-indigo-600 transition">
                See Features
            </a>
        </div>
