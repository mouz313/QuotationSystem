...
<div style="display:flex;align-items:center;gap:.75rem;">
    <label style="position:relative;display:inline-flex;align-items:center;cursor:pointer;">
        ...
        <div style="width:2.75rem;height:1.5rem;background:var(--surface-200);border-radius:9999px;transition:background .2s;position:relative;cursor:pointer;" onmouseover="this.style.background='var(--surface-300)'" onmouseout="this.style.background=this.parentElement.querySelector('input').checked?'var(--brand-600)':'var(--surface-200)'">
        ...
        <script>
            (function(){
                ...
                function sync() {
                    track.style.background = cb.checked ? 'var(--brand-600)' : 'var(--surface-200)';
    ...
    <span style="font-size:.8125rem;color:var(--surface-700);">{{ $label }}</span>
</div>
