...
@section('header-sub', 'Track your company\'s quotation activity')
@section('content')
<div class="fade-in">
    <x-page-header title="Activity Log" subtitle="Track your company's quotation activity" />
            ...
            <form method="GET" style="display:flex;gap:.75rem;align-items:flex-end;flex-wrap:wrap;">
                ...
                <div style="min-width:160px;">
                    <x-form-select name="action" label="Action" value="{{ request('action') }}" placeholder="All Actions"
                        :options="['created' => 'Created', 'updated' => 'Updated', 'deleted' => 'Deleted', 'status_changed' => 'Status Changed', 'login' => 'Login']" />
                </div>
